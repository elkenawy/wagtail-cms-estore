...
class TestElasticsearch7SearchQuery(TestCase):
    ...
    def test_and_filter(self):
        # Create a query
        query = self.query_compiler_class(models.Book.objects.filter(
        ...
        expected_result = {'bool': {'filter': [
            {'match': {'content_type': 'searchtests.Book'}},
            {'bool': {'must': [{'term': {
                'publication_date_filter': '2017-10-18'}}, {'term': {'title_filter': 'Test'}}]}}
        ], 'must': {'multi_match': {'query': 'Hello', 'fields': ['_all_text', '_edgengrams']}}}}
    ...
    def test_negated_filter(self):
        # Create a query
        query = self.query_compiler_class(models.Book.objects.exclude(
    ...
    def test_phrase_query(self):
        ...
        expected_result = {'multi_match': {'fields': [
            '_all_text', '_edgengrams'], 'query': "Hello world", 'type': 'phrase'}}
...
class TestElasticsearch7Mapping(TestCase):
    ...
    def setUp(self):
        # Create ES mapping
        self.es_mapping = Elasticsearch7SearchBackend.mapping_class(
            models.Book)
